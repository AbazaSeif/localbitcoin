...
<html lang="en">
    <head>
        ...
        <title>Админпанель <?php echo HTML_TITLE_DELIMITER, SITE_NAME; ?></title>
        <link href="/template/bootstrap-admin/css/bootstrap.min.css" rel="stylesheet">
        <link href="/template/bootstrap-admin/css/font-awesome.min.css" rel="stylesheet">
        <link href="/template/bootstrap-admin/css/prettyPhoto.css" rel="stylesheet">
        <link href="/template/bootstrap-admin/css/price-range.css" rel="stylesheet">
        <link href="/template/bootstrap-admin/css/animate.css" rel="stylesheet">
        <link href="/template/bootstrap-admin/css/main.css" rel="stylesheet">
        <link href="/template/bootstrap-admin/css/responsive.css" rel="stylesheet">
