...
<head>
    ...
    <!-- MORRIS CHART STYLES-->
    <link href="../../template/bit.team/assets/js/morris/morris-0.4.3.min.css" rel="stylesheet" />
    <!-- CUSTOM STYLES-->
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                       <h5>Данная функция временно недоступна, наслождайтесь другими:)</h2>   
                    </div>
               </div>                          
<!-- /. ROW  -->
...
<script src="../../template/bit.team/assets/js/morris/raphael-2.1.0.min.js"></script>
<script src="../../template/bit.team/assets/js/morris/morris.js"></script>
<!-- CUSTOM SCRIPTS -->
