    ...
    <nav class="navbar-default navbar-side" role="navigation">
      <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
          ...
          <li>
              <a class="active-menu" href="/admin/recall"><i class="fa fa-comments fa-3x" aria-hidden="true"></i> Отзывы</a>
          </li>
          <li>
              ...
              <div class="panel-body">
                <div class="table-responsive">
                  <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <?php foreach ($commentsList as $ticket): ?>
                        <tr>
                          <td><?= $ticket['id']; ?></td>
                          <td><?= User::getUsernameById($ticket['sender_id']); ?></td>
                          <td><?= User::getUsernameById($ticket['receiver_id']); ?></td>
                          <td><?= $ticket['content']; ?></td>
                          <td><?= $ticket['comm_date']; ?></td>
                          <td><button onclick="change_comm(this)" class="bt-clear-delete" title="Редактировать" data-toggle="modal" data-target="#edit"><i class="fa fa-pencil-square-o"></i></button></td>
                          <td><button onclick="document.getElementById('id_comm').value = <?= $ticket['id']; ?> " class="bt-clear-delete" title="Удалить" data-toggle="modal" data-target="#delete"><i class="fa fa-times"></i></button></td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
                  </table>
                      ...
                      <div class="modal-content">
                        <form method="POST" role="form">
                          ...
                          <div class="modal-footer">
                            ...
                            <input type="hidden" id="edit_comm_id" name="edit_comm_id" value="10">
                  ...
                  <div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          Вы действительно хотите <strong>удалить</strong> этот комментарий?<br>
                          Отменить действие будет будет невозможно
                        </div>
                        <div class="modal-footer">
                          <form method="POST">
                            <button type="button" style="outline: none;" class="btn btn-primary" data-dismiss="modal">Отмена</button>
                            <input type="hidden" id="id_comm" name="id_comm" value="10">
